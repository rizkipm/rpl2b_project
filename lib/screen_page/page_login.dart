...
import 'package:rpl2b_project/model/model_login.dart';
...
class _PageLoginState extends State<PageLogin> {
  ...
  Future<ModelLogin?> loginAccount() async{
    try{
      ...
      http.Response res = await http.post(Uri.parse('http://192.168.1.2:8080/beritaDb/login.php'),
          body: {
      ...
      if(data.value == 1){
        setState(() {
          ...
          Navigator.pushAndRemoveUntil(context,
              ...
              => const PageListBerita()), (route) => false);
        });
      }else{
        setState(() {
          isLoading= false;
